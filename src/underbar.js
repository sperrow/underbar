(function() {
  ...
  _.last = function(array, n) {
    return n === undefined ? array[array.length - 1] : n === 0 ? array.slice(0, 0) : array.slice(-n);
  };
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(matchAll, item) {
      if(!matchAll || !iterator(item)) {
        return false;
      }
      return true;
    }, true);
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      if(alreadyCalled[arg] === undefined) {
        alreadyCalled[arg] = func.apply(null, arguments);
      }
  ...
  _.shuffle = function(array) {
    ...
    do {
      ...
      for(var i = 0, length = copy.length; i < length; i++) {
        ...
        if(random === 0) {
          results.unshift(copy[i]);
        } else {
          results.push(copy[i]);
        }
      }
    } while(equals(copy, results));
  ...
  _.invoke = function(collection, functionOrKey, args) {
    ...
    return _.map(collection, function(item) {
      var func = isFunction ? functionOrKey : item[functionOrKey];
